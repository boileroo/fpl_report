...
def _initialize_data(gameweek_str, league_id):
    ...
    return mini_league_data, player_id_to_name, player_id_to_points, player_id_to_position, league_name

def _process_manager_data(mini_league_data, gameweek_int, player_id_to_name, player_id_to_points, player_id_to_position, all_time_stats_manager):
...
def _generate_reports(gameweek_str, league_name, mini_league_data, player_id_to_name, player_id_to_points, player_id_to_position, differential_king_queen, all_time_stats_manager):
...
def main():
    ...
    mini_league_data, player_id_to_name, player_id_to_points, player_id_to_position, league_name = _initialize_data(gameweek_str, league_id)
    ...
    _process_manager_data(mini_league_data, gameweek_int, player_id_to_name, player_id_to_points, player_id_to_position, all_time_stats_manager)
    
    differential_king_queen = get_differential_king_queen(mini_league_data, gameweek_int, player_id_to_name, player_id_to_points)
    
    _generate_reports(gameweek_str, league_name, mini_league_data, player_id_to_name, player_id_to_points, player_id_to_position, differential_king_queen, all_time_stats_manager)
