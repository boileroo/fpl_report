...
def test_workflow_with_validation():
    ...
    try:
        ...
        # Test all-time stats validation with default structure
        from functions.core.all_time_stats import AllTimeStatsManager
        # Create a minimal stats manager to get default structure
        stats_manager = AllTimeStatsManager("test_league", 1)
        default_stats = stats_manager._get_default_stats_structure()
